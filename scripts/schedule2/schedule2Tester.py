...
class SCHEDULE2TESTER:
    ...
    def __init__(self) -> None:
        ...
        self.program = "schedule2"
        self.fileName = "schedule2.c"
    ...
    def dumpDataToTxtFile(self, data, fileName):
    ...
    def cleanUpInput(self, input):
        ...
        pos = input.find("<")
        firstPart = input[:pos]
        secondPart = input[pos+2:]
        return (firstPart,self.path+secondPart)
    ...
    def RandomTestPrioritizationStatementBased(self,coverage):
        ...
        self.dumpDataToTxtFile(statementBasedRandomTestSuite, "random-statement-suite.txt")
    ...
    def RandomTestPrioritizationBranchBased(self,coverage):
        ...
        self.dumpDataToTxtFile(branchBansedRandomTestSuite, "random-branch-suite.txt")
    ...
    def TotalCoveragePrioritizationStatementBased(self):
        ...
        self.dumpDataToTxtFile(totalCoverageBasedTestSuite, "total-statement-suite.txt")
   ...
   # Function to build the test suite using the total coverage prioritization technique - based on branch coverage
    ...
    def TotalCoveragePrioritizationBranchBased(self):
        ...
        self.dumpDataToTxtFile(totalCoverageBasedTestSuite, "total-branch-suite.txt")
        return totalCoverageBasedTestSuite
    ...
    def AdditionalCoveragePrioritizationStatementBased(self):
        ...
        self.dumpDataToTxtFile(additionalCoverageBasedTestSuite, "aditional-statement-suite.txt")
    ...
    def AdditionalCoveragePrioritizationBranchBased(self):
        ...
        print("\nLength of additionalCoverageBasedTestSuite: ", len(additionalCoverageBasedTestSuite))
        self.dumpDataToTxtFile(additionalCoverageBasedTestSuite, "aditional-branch-suite.txt")
        return additionalCoverageBasedTestSuite
    ...
    def evaluateFaultDetectionCapability(self, name):
        ...
        for folder in folders:
            ...
            for test in testSuite:
                ...
                result = subprocess.run(f"./schedule2 {testcase}", shell=True, stderr=subprocess.PIPE, stdout=subprocess.PIPE)
...
if __name__ == "__main__":
    print("Task: For schedule2.c and it's associated universe we have to do the following: ")
    ...
    print("\n-----------------------------4. BUILDING RANDOM TEST SUITE FOR BRANCH COVERAGE--------------------------------------\n")
    ...
    #  Evaluate the fault detection capability of the test suite
    # Options as follows:
