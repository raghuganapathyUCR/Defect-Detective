...
class PRINTTOKENSTESTER:
    ...
    def collectCoverageInfoFromBaseForAllTestCases(self):
        ...
        for i, testcase in enumerate(testcases):
            ...
            result = subprocess.run(f"./printtokens {testcase}", shell=True,stdout=subprocess.PIPE)
    ...
    def evaluateFaultDetectionCapability(self, name):
        ...
        for folder in folders:
            ...
            for test in testSuite:
                ...
                result = subprocess.run(f"./printtokens {testcase}", shell=True, stderr=subprocess.PIPE, stdout=subprocess.PIPE)
