...
class SCHEDULETESTER:
    ...
    # Function to write the test suite to a file, each testcase is on a new line
    ...
    def collectCoverageInfoFromBaseForAllTestCases(self):
        ...
        for i, testcase in enumerate(testcases):
            ...
            result = subprocess.run(f"./schedule {testcase}", shell=True, stdout=subprocess.PIPE)
    ...
    def evaluateFaultDetectionCapability(self, name):
        ...
        for folder in folders:
            ...
            for test in testSuite:
                ...
                result = subprocess.run(f"./schedule {testcase}", shell=True, stderr=subprocess.PIPE, stdout=subprocess.PIPE)
